    ...
    <div className="min-h-screen bg-slate-50">
      <header className="border-b border-slate-200 bg-white">
        <div className="mx-auto max-w-7xl px-6 py-4 flex items-center justify-between">
          <div className="text-lg font-semibold">Done-for-you Template</div>
      ...
      <main className="mx-auto max-w-4xl px-6 py-10">
        <Card className="p-8">
          <div className="text-3xl font-extrabold tracking-tight">All-in-one landing</div>
          <p className="mt-3 text-slate-600">Дэлгэрэнгүй мэдээлэлтэй олон section-тай хувилбар.</p>
